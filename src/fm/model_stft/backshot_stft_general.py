...
"""
==============================================================================
STFT U-Net 2D Training Script - GENERAL MODEL
==============================================================================

Created: 22/11/2025

Trains STFT-based U-Net 2D on COMBINED dataset (LibriSpeech + Music)
...
- Combined speech + music training
- Early stopping with checkpoints

Output: saved_models/stft_general_100_norm/unet2d_best_general.pth
==============================================================================
"""

# --- Configuration ---
class Config:
    # Paths - Combined speech + music
    CLEAN_AUDIO_DIRS = [
    ...
    MODEL_SAVE_PATH = str(Paths.MODEL_STFT_GENERAL_BEST)
    CHECKPOINT_DIR = str(Paths.MODEL_STFT_GENERAL_BEST.parent / "checkpoints")
...
class OnFlySTFTNoiseDataset(Dataset):
    ...
    def __init__(self, clean_dirs, noise_file, audio_length, sample_rate,
        ...
        # Collect all clean audio files (flac for speech, mp3/wav/flac for music)
...
def main():
    ...
    print("="*70)
    print("STFT U-Net 2D Training - GENERAL MODEL (Speech + Music)")
    print("="*70)
    ...
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.title('STFT U-Net 2D Training History (General)')
    plt.legend()
    plt.grid(True)
