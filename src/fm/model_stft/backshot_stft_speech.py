...
"""
==============================================================================
STFT U-Net 2D Training Script - SPEECH MODEL
==============================================================================

Created: 22/11/2025

Trains STFT-based U-Net 2D on LibriSpeech (dev-clean + dev-other)
...
Output: saved_models/stft_speech_100_norm/unet2d_best_speech.pth
==============================================================================
"""
...
class Config:
    ...
    MODEL_SAVE_PATH = str(Paths.MODEL_STFT_SPEECH_BEST)
    CHECKPOINT_DIR = str(Paths.MODEL_STFT_SPEECH_BEST.parent / "checkpoints")
...
class OnFlySTFTNoiseDataset(Dataset):
    ...
    def __init__(self, clean_dirs, noise_file, audio_length, sample_rate,
        ...
        for clean_dir in clean_dirs:
            ...
            flac_files = list(clean_path.rglob('*.flac'))
            self.clean_files.extend(flac_files)
...
def main():
    ...
    print("="*70)
    print("STFT U-Net 2D Training - SPEECH MODEL")
    print("="*70)
    ...
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.title('STFT U-Net 2D Training History (Speech)')
    plt.legend()
    plt.grid(True)
