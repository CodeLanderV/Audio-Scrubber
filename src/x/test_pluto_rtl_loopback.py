...
def main():
    ...
    # Set Pluto TX gain to 0 dB (max power, no attenuation)
    pluto_tx.configure(freq=915e6, rate=2e6, gain=0)
    ...
    # Set RTL-SDR gain to max (try 50 or 60 dB, depending on your stick)
    rtl_rx.configure(freq=915e6, rate=2e6, gain=60)
