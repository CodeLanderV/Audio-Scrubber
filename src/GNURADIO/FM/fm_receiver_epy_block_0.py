...
MODEL_PATH = r"D:\Bunker\OneDrive - Amrita vishwa vidyapeetham\BaseCamp\AudioScrubber\saved_models\FM\FinalModels\FM_Final_1DUNET\general.pth"
...
try:
    from neuralnet import UNet1D  # Assuming class name is UNet1D for FM
except ImportError:
