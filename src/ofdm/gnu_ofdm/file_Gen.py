...
class file_Gen(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'D:\\Bunker\\OneDrive - Amrita vishwa vidyapeetham\\BaseCamp\\AudioScrubber\\Tests\\image.jpg', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'D:\\Bunker\\OneDrive - Amrita vishwa vidyapeetham\\BaseCamp\\AudioScrubber\\src\\ofdm\\gnu_ofdm\\captured.iq', False)
