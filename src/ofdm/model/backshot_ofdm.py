"""
================================================================================
OFDM DENOISING MODEL TRAINER (BACKSHOT)
================================================================================
Memory-optimized training for OFDM_UNet on IQ dataset from dataset/OFDM/

Features:
- Streaming data loading (minimal RAM usage)
- CUDA support with automatic batch size detection
- Automatic Mixed Precision (AMP) training
- Early stopping (auto-stops after 20 epochs of no improvement)
...
Usage:
    python src/ofdm/model/backshot_ofdm.py
    python src/ofdm/model/backshot_ofdm.py --epochs 100 --batch-size 32
    python src/ofdm/model/backshot_ofdm.py --resume saved_models/OFDM/checkpoint_epoch_10.pth
================================================================================
"""
